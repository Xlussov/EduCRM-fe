...
// 1. Единая базовая схема. Пароль ВСЕГДА опционален для TypeScript.
...
// Экспортируем единственный стабильный тип
export type AdminFormValues = z.infer<typeof baseSchema>;

// 2. Функция валидации: проверяет пароль ТОЛЬКО если мы создаем админа
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 max-w-xl">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* 3. Рендерим поле пароля ТОЛЬКО если это создание нового админа */}
          {!isEditMode && (
            <FormField
              control={form.control}
              name="password"
